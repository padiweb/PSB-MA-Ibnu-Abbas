...
<div class="card border-0 rounded-3 mb-4" style="box-shadow:0 2px 12px rgba(0,0,0,.06);">
    <div class="card-body p-3">
        <form method="GET" action="/admin/biaya">
            ...
            <tr>
                ...
                <td class="text-center">
                    <div class="d-flex gap-1 justify-content-center">
                        ...
                        <form method="POST" action="/admin/biaya/<?= $b['id'] ?>/hapus" class="d-inline">
...
<div class="modal fade" id="modalBiaya" tabindex="-1">
    <div class="modal-dialog">
        <div class="modal-content border-0 rounded-3">
            ...
            <form method="POST" id="formBiaya" action="/admin/biaya/simpan">
                <input type="hidden" name="csrf_token" value="<?= Security::csrfToken() ?>">
