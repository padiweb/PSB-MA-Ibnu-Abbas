...
<div class="page-header d-flex align-items-center justify-content-between">
    ...
    <a href="/admin/export" class="btn btn-sm" style="background:var(--primary);color:#fff;">
...
<div class="card border-0 rounded-3 mb-4" style="box-shadow:0 2px 12px rgba(0,0,0,.06);">
    <div class="card-body p-3">
        <form method="GET" action="/admin/pendaftar" id="filterForm">
            <div class="row g-2 align-items-end">
                ...
                <div class="col-6 col-md-1">
                    <a href="/admin/pendaftar" class="btn btn-sm btn-outline-secondary w-100">Reset</a>
                </div>
            </div>
        </form>
    </div>
                ...
                <tr>
                    ...
                    <td class="text-center">
                        <div class="d-flex gap-1 justify-content-center">
                            <a href="/admin/pendaftar/<?= $p['id'] ?>" class="btn btn-sm btn-outline-primary" title="Detail" style="padding:3px 8px;">
                                <i class="bi bi-eye"></i>
                            </a>
                            <a href="/admin/pendaftar/<?= $p['id'] ?>/cetak" class="btn btn-sm btn-outline-secondary" title="Cetak" style="padding:3px 8px;" target="_blank">
