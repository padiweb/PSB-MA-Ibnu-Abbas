...
<head>
    ...
    <title><?= htmlspecialchars($page_title ?? 'Dashboard') ?> | <?= Security::clean($settings['site_name'] ?? APP_NAME) ?></title>
...
<main style="background:#f0f4f8;padding:2.5rem 0;min-height:60vh;">
    <div class="container">
        <?= $content ?>
    </div>
</main>
